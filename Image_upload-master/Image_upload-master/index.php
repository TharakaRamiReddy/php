...
<input type="button" value='Birthdays' name ="Birthdays" class="btn btn-primary btn-xs" onclick="location.href = 'Birthdays.php';" />
<input type="button" class="btn btn-success btn-xs " value="Marriages" onclick="location.href = 'Marriages.php';">
 <input type="button" class="btn btn-info btn-xs " value="Events" onclick="location.href = 'Marriages.php';">
